                    ...
                    if msg.contentType == 0:
                        if text is None:
                            ...
                            if cmd == "help":
                                ...
                                kifli.sendContact(to, "ufd1fc96a20d7cf0a8e6e8dfc117f32be")
                            elif cmd == "tts":
...
#------------------------------------============================------------------------------------#
                                ...
                                wait["autoAdd"] = True
                                kifli.sendMessage(to, "ᴀᴜᴛᴏ ᴀᴅᴅ ᴏɴ")
                            elif cmd == "autoadd off":
                                wait["autoAdd"] = False
                                kifli.sendMessage(to, "ᴀᴜᴛᴏ ᴀᴅᴅ ᴏғғ")
                            elif cmd == "autojoin on":
                                wait["autoJoin"] = True
                                kifli.sendMessage(to, "ᴀᴜᴛᴏ ᴊᴏɪɴ ᴏɴ")
                            elif cmd == "autojoin off":
                                wait["autoJoin"] = False
                                kifli.sendMessage(to, "ᴀᴜᴛᴏ ᴊᴏɪɴ ᴏɴ ᴏғғ")
                            elif cmd == "autoleave on":
                                wait["autoLeave"] = True
                                kifli.sendMessage(to, "ᴀᴜᴛᴏ ʟᴇᴀᴠᴇ ᴏɴ")
                            elif cmd == "autoleave off":
                                wait["autoLeave"] = False
                                kifli.sendMessage(to, "ᴀᴜᴛᴏ ʟᴇᴀᴠᴇ ᴏғғ")
                                ...
                                kifli.sendMessage(to, "ᴀᴜᴛᴏ ʀᴇsᴘᴏɴ ᴏɴ")
                            elif cmd == "autorespon off":
                                wait["autoRespon"] = False
                                kifli.sendMessage(to, "ᴀᴜᴛᴏ ʀᴇsᴘᴏɴ ᴏғғ")
                            elif cmd == "autoread on":
                                wait["autoRead"] = True
                                kifli.sendMessage(to, "ᴀᴜᴛᴏ ʀᴇᴀᴅ ᴏɴ")
                            elif cmd == "autoread off":
                                wait["autoRead"] = False
                                kifli.sendMessage(to, "ᴀᴜᴛᴏ ʀᴇᴀᴅ ᴏғғ")
                                ...
                                try:
                                    ...
                                    kifli.sendContact(to, "ua49645de5bf35bec5fe7428089801737")
...
#------------------------------------============================------------------------------------#
                                ...
                                contact = kifli.getContact(sender)
                                kifli.sendImageWithURL(to,"http://dl.profile.line-cdn.net/{}".format(contact.pictureStatus))
...
#buat cek token
                            	...
                            	kifli.sendMessage(receiver,"ஜ۩ your access token ۩ஜ\n"+line.authToken)
                        ...
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                if " " in Name:
                                    nick = Name.split(' ')
                                    if len(nick) == 2:
                                        kifli.sendMessage(op.param1, "Ass " + "☞ " + Name + " ☜" + "\nᴅɪᴇᴍ ᴅɪᴇᴍ ʙᴀᴇ...\nsini cari target\nbuat kojom  ")
                                    else:
                                        kifli.sendMessage(op.param1, "Beb " + "☞ " + Name + " ☜" + "\nanda trcyduk cctv\nsini ikut gosip donk\nmasya allah  ")
                                else:
                                    kifli.sendMessage(op.param1, "Asslamu alaikum\n si " + "☞ " + Name + " ☜" + "\ndirimu terdeteksi cctv\nastaghfirullah\nsi  " + Name + " mari ikut ngopi")
                        else:
                            pass
                    else:
                        pass
